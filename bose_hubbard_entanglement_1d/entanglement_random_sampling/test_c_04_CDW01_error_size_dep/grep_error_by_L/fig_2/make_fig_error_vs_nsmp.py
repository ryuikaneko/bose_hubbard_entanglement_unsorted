...
#        plt.plot(xx,np.sqrt(aas[i,1]/xx),color=cmap(i))
        plt.plot(xx,np.sqrt(np.abs(aas[i,1]/xx)),color=cmap(i))
    i=0
#    plt.plot(xx,aas[i,1]*xx**(-0.5),color=cmap(i),label=r"$\sqrt{c(L)/N_{\mathrm{total}}}$")
#    plt.plot(xx,np.sqrt(aas[i,1]/xx),color=cmap(i),label=r"$\sqrt{c(L)/N_{\mathrm{total}}}$")
    plt.plot(xx,np.sqrt(np.abs(aas[i,1]/xx)),color=cmap(i),label=r"$\sqrt{c(L)/N_{\mathrm{total}}}$")
