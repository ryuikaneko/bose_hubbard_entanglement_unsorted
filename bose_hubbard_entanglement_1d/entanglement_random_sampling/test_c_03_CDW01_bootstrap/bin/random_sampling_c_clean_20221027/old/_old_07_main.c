...
//// open files
  ...
  sprintf(buf_renyij,"dat_renyij_L%d_t%.10f",L,tstep);
  sprintf(buf_renyib,"dat_renyib_L%d_t%.10f",L,tstep);
...
////       perm(A).re, error, perm(A).im, error
  fprintf(fp_renyij,"%.10g %.10g %.10g %.10g %.10g %.10g %.10g %.10g %.10g\n",
  ...
  fprintf(fp_renyib,"%.10g %.10g %.10g %.10g %.10g %.10g %.10g %.10g %.10g\n",
