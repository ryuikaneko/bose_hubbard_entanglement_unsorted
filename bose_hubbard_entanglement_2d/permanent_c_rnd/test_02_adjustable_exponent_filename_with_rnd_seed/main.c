...
//// open files
  ...
  sprintf(buf_setup,"dat_setup_Lx%d_Ly%d_t%.10f_e%d_r%llu_s%llu",Lx,Ly,tstep,exponent,seed[0],seed[1]);
  sprintf(buf_time,"dat_time_Lx%d_Ly%d_t%.10f_e%d_r%llu_s%llu",Lx,Ly,tstep,exponent,seed[0],seed[1]);
  sprintf(buf_renyij,"dat_renyij_Lx%d_Ly%d_t%.10f_e%d_r%llu_s%llu",Lx,Ly,tstep,exponent,seed[0],seed[1]);
  sprintf(buf_renyib,"dat_renyib_Lx%d_Ly%d_t%.10f_e%d_r%llu_s%llu",Lx,Ly,tstep,exponent,seed[0],seed[1]);
  sprintf(buf_varj,"dat_varj_Lx%d_Ly%d_t%.10f_e%d_r%llu_s%llu",Lx,Ly,tstep,exponent,seed[0],seed[1]);
  sprintf(buf_varb,"dat_varb_Lx%d_Ly%d_t%.10f_e%d_r%llu_s%llu",Lx,Ly,tstep,exponent,seed[0],seed[1]);
  sprintf(buf_histblock_binary,"dat_histblock_binary_Lx%d_Ly%d_t%.10f_e%d_r%llu_s%llu",Lx,Ly,tstep,exponent,seed[0],seed[1]);
  sprintf(buf_histblock,"dat_histblock_Lx%d_Ly%d_t%.10f_e%d_r%llu_s%llu",Lx,Ly,tstep,exponent,seed[0],seed[1]);
...
//// calculate entanglement
  ...
  if(flag_histtotal==1){
    ...
    sprintf(buf_histtotal_binary,"dat_histtotal_binary_Lx%d_Ly%d_t%.10f_e%d_r%llu_s%llu",Lx,Ly,tstep,exponent,seed[0],seed[1]);
