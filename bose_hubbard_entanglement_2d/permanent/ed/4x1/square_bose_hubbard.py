...
def parse_args():
    ...
    parser.add_argument("-Lx",metavar="Lx",dest="Lx",type=int,default=4,help="set Lx(=4, size)")
    parser.add_argument("-Ly",metavar="Ly",dest="Ly",type=int,default=1,help="set Ly(=1, size)")
