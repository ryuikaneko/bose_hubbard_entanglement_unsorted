...
def parse_args():
    ...
    parser.add_argument("-Lx",metavar="Lx",dest="Lx",type=int,default=2,help="set Lx(=2, size)")
    parser.add_argument("-Ly",metavar="Ly",dest="Ly",type=int,default=2,help="set Ly(=2, size)")
    parser.add_argument("-Nb",metavar="Nb",dest="Nb",type=int,default=2,help="set Nb(=2, number of bosons)")
    parser.add_argument("-Nsps",metavar="Nsps",dest="Nsps",type=int,default=5,help="set Nsps(=5, local Hilbert space)")
...
#    string = "0101" ## for 4x1 lattice
    string = "0110" ## for 2x2 lattice
#    print(string)
#    print(basis_1d)
