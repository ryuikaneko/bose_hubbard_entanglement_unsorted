...
#    parser.add_argument("-Nsps",metavar="Nsps",dest="Nsps",type=int,default=17,help="set Nsps(=17, local Hilbert space)")
    parser.add_argument("-Nsps",metavar="Nsps",dest="Nsps",type=int,default=9,help="set Nsps(=9, local Hilbert space)")
...
#    string = "010101010101" ## for 3x4 lattice
    string = "0101101001011010" ## for 4x4 lattice
#    print(string)
#    print(basis_1d)
